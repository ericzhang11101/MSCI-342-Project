...
export default function SoftwareEngineeringOption() {
  return (
    <Box sx={{           display: "flex",
    ...
    overflowY: "scroll", }}>
      ...
      The Software Engineering Option is available to all students in the Faculty of Engineering, 
    ...
    Three Required Courses:
        ...
        CS 447/ECE 453 or SE 465 Software Testing, Quality Assurance and Maintenance, or Software Testing and Quality Assurance
